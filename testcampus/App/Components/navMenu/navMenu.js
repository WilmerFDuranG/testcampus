            ...
            <nav>
                <div class="nav-container">
                    ...
                    <ul class="links-container">               
                        ...
                        <li class="link-item"><a class="mainMenu" href="#" data-verocultar='["t"]'><img src="/img/carrito.png" width=30px></a></li>
                ...
                val.addEventListener("click", (e)=>{
                    ...
                    switch (data[0]){
                      ...
                      case 't':
                        ...
                        break;
                        case 's':
                          mainContent.innerHTML="<carrito-content></carrito-content>";
                          break;  
                    }
